...
function set_article_final(object $pdo, string $imageUrl, string $username, string $title, string $genre, string $article, int $userId) {

    $query = "INSERT INTO articles (creator, imageUrl, title, genre, article_content, users_id) VALUES 
